...
//------------------------------------------------------------------
// [for CDrawer] ロジック用表示オフセット（※[eDP_LAYER_GAME]内部での表示順）
//------------------------------------------------------------------
enum eDL_OFS_LOGIC{
    eDL_OFS_LOGIC_INVALID = -1,         // 無効（非表示）
    
    eDL_OFS_LOGIC_UI,               // UI
    eDL_OFS_LOGIC_CURSOR,           // カーソル
    eDL_OFS_LOGIC_PHRASE,           // フレーズ
    eDL_OFS_LOGIC_SOLID_BLOCK,      // マスブロック
    eDL_OFS_LOGIC_GUIDE,            // ガイド
    eDL_OFS_LOGIC_CLUE,             // ヒント
    eDL_OFS_LOGIC_SOLID,            // マス
    eDL_OFS_LOGIC_BOARD,            // 盤面
    
    // [CDrawer.m_nCurDrawPriority]との兼ね合いがあるので「１００」までに収めること
    eDL_OFS_MAX,
};
...
/*+----------------------------------------------------------------+
  ...
  +----------------------------------------------------------------+*/
// ラベル：描画関連
extern const char* g_pArrDrawProcessLabel[];
extern const char* g_pArrDrawLayerLabel[];

// ラベル：ループID
extern const char* g_pArrLoopIdLabel[];
