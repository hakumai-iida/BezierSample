...
#define BEZIER_WP_HOOK_POINT_PAL                0x80    // アンカーポイント色（HOOK）
#define BEZIER_WP_HOOK_TEMP_POINT_PAL           0x90    // アンカーポイント色（テンポラリHOOK）
#define BEZIER_WP_HOOK_SYSTEM_POINT_PAL         0xA0    // アンカーポイント色（システムHOOK＝ジョイント）
