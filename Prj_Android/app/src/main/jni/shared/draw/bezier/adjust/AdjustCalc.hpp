...
public:
    ...
    // 角度計算：テンション（スロット＝パーツ）
    //-------------------------------------------------------------
    static void CalcRateRotForT( int* pOutRateRot, float minRate, float maxRate, float fixedAdjustRate );

    //-------------------------------------------------------------
    // サイズ計算：サイズ（スロット＝パーツ）
    //-------------------------------------------------------------
    static void CalcRateScaleForS( int* pOutRateScale, float minRate, float maxRate, float fixedAdjustRate );
