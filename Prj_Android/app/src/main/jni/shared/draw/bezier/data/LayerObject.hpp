...
private:
    ...
    //（※この値の読み込み／書き込みは[CLayerData]にて管理される）
...
public:
    ...
    // 適用（※引数付き）
    void applyTempAdjust( int oRX, int oRY, int sRX, int sRY );
    void applyTempAdjustForMaxH( int oRX, int oRY, int sRX, int sRY );
    void applyTempAdjustForMinH( int oRX, int oRY, int sRX, int sRY );
    void applyTempAdjustForMaxV( int oRX, int oRY, int sRX, int sRY );
    void applyTempAdjustForMinV( int oRX, int oRY, int sRX, int sRY );
};
