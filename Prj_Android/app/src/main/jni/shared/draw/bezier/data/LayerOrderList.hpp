...
public:
    ...
    // セルの取得／登録
    CLayerOrderCell* getOrderCell( eBD_SLOT slot, int slotIndex );
    stLAYER_ORDER_CELL_NODE* addLayerData( CLayerData* pData, eBD_LAYER_ORDER_TYPE type, eBD_SLOT slot, int slotIndex );
