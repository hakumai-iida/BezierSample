...
/*+----------------------------------------------------------------+
  ...
  +----------------------------------------------------------------+*/
// 確保サイズ
#define MAX_ALLOC_SLOT_OBJECT_DATA   (4*1024)
...
// 調整値クリア
//------------
void CSlotObjectData::clearAdjust( void ){
...
void CSlotObjectData::setEditValueMenu( CEditValueMenu* pMenu ){
    ...
    // フラグ
    pMenu->setItemAtAsBit( id++, "FLAG: DISABLE", &m_nFlag, eEDIT_VALUE_TYPE_INT32, eSOD_FLAG_DISABLE );
    pMenu->setItemAtAsBit( id++, "FLAG: MIRROR_COPY", &m_nFlag, eEDIT_VALUE_TYPE_INT32, eSOD_FLAG_MIRROR_COPY );
