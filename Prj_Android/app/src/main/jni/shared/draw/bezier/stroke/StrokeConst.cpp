...
const char* g_pArrLabelStrokeHookTarget[] = {
    ...
    // 特定
    "NECK_TO_HEAD_L",       "NECK_TO_HEAD_R",
    "HAIR_SIDE_L",          "HAIR_SIDE_R",
    "HAIR_BAND_L",          "HAIR_BAND_R",

    "HAIR_STROKE_0_L",      "HAIR_STROKE_0_R",
    "HAIR_STROKE_1_L",      "HAIR_STROKE_1_R",
    "HAIR_STROKE_2_L",      "HAIR_STROKE_2_R",
    "HAIR_STROKE_3_L",      "HAIR_STROKE_3_R",
    "HAIR_STROKE_4_L",      "HAIR_STROKE_4_R",
    
    "ARM_TO_BACK_L",        "ARM_TO_BACK_R",
    "APRON_UP_OUT_L",       "APRON_UP_OUT_R",
    "APRON_UP_IN_L",        "APRON_UP_IN_R",
    "APRON_UP_BORDER_L",    "APRON_UP_BORDER_R",
    "APRON_LOW_OUT_L",      "APRON_LOW_OUT_R",
    "APRON_LOW_IN_L",       "APRON_LOW_IN_R",
    "APRON_LOW_BORDER_L",   "APRON_LOW_BORDER_R",
