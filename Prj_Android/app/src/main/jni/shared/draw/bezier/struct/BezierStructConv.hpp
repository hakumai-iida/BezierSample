/*+----------------------------------------------------------------+
  |	Title:		BezierStructConv.hpp [共通環境]
  |	Comment:	ベジェ関連構造体変換
  |	Author:		K.Takayanagi
  +----------------------------------------------------------------+*/
/*+----------------------------------------------------------------+
  |	Header Define	ヘッダ定義
  +----------------------------------------------------------------+*/
#ifndef __BEZIER_STRUCT_CONV_HPP__
#define __BEZIER_STRUCT_CONV_HPP__
...
private:
    // インスタンス作成は不可
    CBezierStructConv( void ){}
    virtual ~CBezierStructConv( void ){}
};
...
/*+----------------------------------------------------------------+
  |	Prototype	プロトタイプ宣言
  +----------------------------------------------------------------+*/
#endif	/* __BEZIER_STRUCT_CONV_HPP__ */
