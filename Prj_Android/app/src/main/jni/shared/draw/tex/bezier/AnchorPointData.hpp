...
protected:
    ...
    // オプション制御
    //-------------------------------------------------
    eBD_OPTION  m_eOptionForValid;      // オプション指定があれば表示する
    eBD_OPTION  m_eOptionForInvalid;    // オプション指定があれば非表示にする
...
public:
    ...
    // オプション指定
    inline void setOptionForValid( eBD_OPTION option ){ m_eOptionForValid = option; }
    inline void setOptionForInvalid( eBD_OPTION option ){ m_eOptionForInvalid = option; }
    ...
    // オプション指定
    inline eBD_OPTION getOptionForValid( void ){ return( m_eOptionForValid ); }
    inline eBD_OPTION getOptionForInvalid( void ){ return( m_eOptionForInvalid ); }
    
    //-------------------------------
    // 有効性の確認
    //-------------------------------
    bool isValid( bool* arrOption );
